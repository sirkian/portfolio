...
const Contact = () => {
  return (
    <div className="h-full flex items-center justify-center gap-5 flex-col md:flex-row py-8 md:py-0">
      <div className="flex-1 flex flex-col items-center p-5 gap-5 md:gap-10 text-center md:text-justify">
